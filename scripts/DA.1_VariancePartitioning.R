...
writexl::write_xlsx(individual_leaf_count, "C:/Users/tjgau/Desktop/Work/PFTC5/individual_leaf_count.xlsx")
...
#### Creating dataset with individuals with only 4 leaves ####
#selecting individuals with only 4 leaves
...
varpart_real <- output2 %>% 
  mutate(part = plyr::mapvalues(Scale, from = c("Unexplained", 
...
boot_summary$lower <- as.factor(boot_summary$lower)
boot_summary$upper <- as.factor(boot_summary$upper)
...
#### ARCHIE - Model Structure 2 broken down by site ####
